...
@Component({
  selector: 'app-quick-ride-inputs2',
  templateUrl: './quick-ride-inputs2.component.html',
  styleUrls: ['./quick-ride-inputs2.component.css']
})
export class QuickRideInputs2Component implements OnInit {
